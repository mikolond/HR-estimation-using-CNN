...
CONFIG_PATH = os.path.join("config_files", "pure", "config_extractor_pure_halmos_exp23.yaml")
# CONFIG_PATH = os.path.join("config_files", "pure_local", "config_extractor_pure_exp1.yaml")
# CONFIG_PATH = os.path.join("config_files", "latent_model_test", "config_extractor_pure_halmos_latent3_exp2.yaml")
