...
class Extractor(nn.Module):
    def __init__(self):
        ...
        # 26 x 19
        self.conv4 = create_layer(["DP2",0.05,"CONV",ch, ch, (12,8), c_st, pad,"MP",(12,8), m_st, "BN", ch,"ELU", alpha_elu])
        # 4 x 5
        # make 88 x 1 vector
        ...
        # batch_size x 12
        self.conv5 = create_layer(["DP",0.0,"CONV_dil",ch, ch, (3,3), (1,1), (1,0), (1,1), "ELU", alpha_elu])
        self.conv6 = create_layer(["DP",0.0,"CONV_dil",ch, ch, (3,3), (1,1), (2,0), (2,1),"ELU", alpha_elu])
        self.conv7 = create_layer(["DP",0.0,"CONV_dil",ch, ch, (3,3), (1,1), (3,0), (3,1),"ELU", alpha_elu])

        self.maxpool1 = nn.MaxPool2d(kernel_size=(3,3), stride=(2,2), padding=(0,0))

        self.conv8 = create_layer(["DP",0.0,"CONV_dil",ch, ch, (3,3), (1,1), (1,0), (1,1),"ELU", alpha_elu])
        self.conv9 = create_layer(["DP",0.0,"CONV_dil",ch, ch, (3,3), (1,1), (2,0), (2,1),"ELU", alpha_elu])
        self.conv10 = create_layer(["DP",0.1,"CONV_dil",ch, ch, (3,3), (1,1), (3,0), (3,1),"ELU", alpha_elu])
    ...
    def forward(self, x):
        ...
        x = torch.cat((x1,x2,x3),3).reshape(1,x.shape[1],x.shape[2],3*18)
        ...
        x = torch.cat((x1,x2,x3),3).reshape(1,x.shape[1],x.shape[2],3*24)
