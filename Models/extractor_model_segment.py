...
class Extractor(nn.Module):
    def __init__(self):
        ...
        self.conv0 = create_layer(["CONV", in_ch, ch1, (3,3), (1,1), (1,1), "BN", ch1,"ELU", alpha_elu])
        self.conv1 = create_layer(["CONV", ch1, ch1, c_k_size, c_st, pad,"MP" ,m_k_size, (2,2), "BN", ch1,"ELU", alpha_elu])
        # 89 x 60
